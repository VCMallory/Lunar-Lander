...
void activegame5(ALLEGRO_EVENT_QUEUE** queue, ALLEGRO_EVENT* event, int* onEmpezar, ALLEGRO_BITMAP** nave, ALLEGRO_BITMAP** empezarbackground, ALLEGRO_KEYBOARD_STATE* keystate, float* fuel, int* score)
{
    ...
    plataforma2 = al_load_bitmap("resources/background/plataforma5.png");
    ...
    *onEmpezar = 1;
    ...
    while (*onEmpezar == 1) {
        ...
        if (y > 350 && x > 71 && x < 117 && v < 0.6) {
            *score = *score + 100;
            *onEmpezar = 0;/*WIN*/
            activegame6(&*queue, &*event, &*onEmpezar, &*nave, &*empezarbackground, &*keystate, &*fuel, &*score);
        ...
        if (event->type == ALLEGRO_EVENT_TIMER) {
            ...
            al_draw_bitmap(plataforma2, 0, 333, 0); /*PLATFORM 2*/
